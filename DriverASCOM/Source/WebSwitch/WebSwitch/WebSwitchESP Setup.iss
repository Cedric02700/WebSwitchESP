...
; Generated by Gronnier Cedric on 17/01/2022 (UTC)
;
[Setup]
AppID={{2f156b3e-5dbc-425d-a80c-c234ab0540f3}
AppName=ASCOM WebSwitchESP Switch Driver
AppVerName=ASCOM WebSwitchESP Switch Driver 0.1
AppVersion=0.1
AppPublisher=Gronnier Cedric <gronnier.cedric@live.fr>
AppPublisherURL=mailto:gronnier.cedric@live.fr
...
OutputDir="."
OutputBaseFilename="WebSwitchESP Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\WebSwitchESP"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\WebSwitchESP"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Cedric\source\repos\WebSwitch\WebSwitch\bin\Release\ASCOM.WebSwitch.Switch.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Cedric\source\repos\WebSwitch\WebSwitch\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.WebSwitch.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.WebSwitch.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.WebSwitch.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.WebSwitch.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.WebSwitch.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
