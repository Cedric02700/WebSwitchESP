...
//
// ASCOM Switch driver for WebSwitch
//
...
{
    //
    // Your driver's DeviceID is ASCOM.WebSwitch.Switch
    //
    // The Guid attribute sets the CLSID for ASCOM.WebSwitch.Switch
    // The ClassInterface/None attribute prevents an empty interface called
    // _WebSwitch from being created and used as the [default] interface
    //
    ...
    /// ASCOM Switch Driver for WebSwitch.
    /// </summary>
    [Guid("4dff6787-2f45-466b-8d38-5a01e3833ef2")]
    ...
    public class Switch : ISwitchV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.WebSwitch.Switch";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "WebSwitchESP";
        ...
        internal static int timeOut = 3500;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebSwitch"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Switch()
        {
            tl = new TraceLogger("", "WebSwitchESP");
        ...
        internal static short numSwitch = 5; //private
        ...
        public string GetSwitchName(short id)
        {
                ...
                string messageUrl = string.Format("http://" + comPort + "/R" + idSwitch[id] + "NNN");
        ...
        public void SetSwitchName(short id, string name)
        {
                ...
                string[] idSwitch = new string[] { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N" };
                string messageUrl = string.Format("http://" + comPort + "/R" + idSwitch[id] + "XXX" + name + "FFF");
                WebRequest request = WebRequest.Create(messageUrl);                
                WebResponse response = request.GetResponse();
                response.Close();
        ...
        {
            string[] idSwitch = new string[] { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N" };
            string messageUrl = string.Format("http://" + comPort + "/R" + idSwitch[id] + "SSS");
            WebRequest request = WebRequest.Create(messageUrl);            
            WebResponse response = request.GetResponse();
            string responseName = System.String.Empty;
            using (Stream dataStream = response.GetResponseStream())
            ...
            tl.LogMessage("GetSwitch", string.Format("GetSwitchName({0})", id));
            Boolean responseState = false;
            if ((responseName.IndexOf("0") < 0)) responseState = true;
        ...
        public void SetSwitch(short id, bool state)
        {
                ...
                string stateUrl = "E";
                if (state) stateUrl = "A";
                string messageUrl = string.Format("http://" + comPort + "/R" + idSwitch[id] + stateUrl);
                HttpWebRequest httpRequest = (HttpWebRequest)WebRequest.Create(messageUrl);                
